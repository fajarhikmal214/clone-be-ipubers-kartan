...
[Index("IdBilling", Name = "Penjualan_IdBilling_uindex")]
[Index("NoReferensi", Name = "Penjualan_NoReferensi_index")]
[Index("IdRetailer", "JenisPenjualan", Name = "idx_penjualan_idertailer_jenispenjualandev")]
[Index("IdRetailer", "SyncAlokasiStatus", Name = "idx_penjualan_idretailer_sync")]
public partial class Penjualan
{
    ...
    [Column(TypeName = "datetime")]
    public DateTime? SyncRekanAt { get; set; }

    public byte? SyncRekanStatus { get; set; }

    [StringLength(500)]
    [Unicode(false)]
    public string? SyncRekanMessage { get; set; }

    [Column(TypeName = "datetime")]
    public DateTime? SyncAlokasiAt { get; set; }

    public byte? SyncAlokasiStatus { get; set; }

    [StringLength(500)]
    [Unicode(false)]
    public string? SyncAlokasiMessage { get; set; }
    ...
    /// <summary>
    /// billing untuk dikirimkan ke bank
    /// </summary>
    [StringLength(15)]
    [Unicode(false)]
    ...
    [InverseProperty("IdPenjualanNavigation")]
    public virtual ICollection<PenjualanAddInfo> PenjualanAddInfos { get; set; } = new List<PenjualanAddInfo>();

    [InverseProperty("IdPenjualanNavigation")]
    public virtual ICollection<PenjualanBilling> PenjualanBillings { get; set; } = new List<PenjualanBilling>();

    [InverseProperty("IdPenjualanNavigation")]
    public virtual ICollection<PenjualanDetail> PenjualanDetails { get; set; } = new List<PenjualanDetail>();

    [InverseProperty("IdPenjualanNavigation")]
    public virtual PenjualanFcm? PenjualanFcm { get; set; }
