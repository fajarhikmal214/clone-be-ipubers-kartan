...
public partial class Retailer
{
    ...
    public virtual ICollection<AlamatKio> AlamatKios { get; set; } = new List<AlamatKio>();
    ...
    [InverseProperty("IdRetailerNavigation")]
    public virtual ICollection<PembelianPoktan> PembelianPoktans { get; set; } = new List<PembelianPoktan>();
    ...
    [InverseProperty("IdRetailerNavigation")]
    public virtual ICollection<PenjualanBatch> PenjualanBatches { get; set; } = new List<PenjualanBatch>();
    ...
    [InverseProperty("IdRetailerNavigation")]
    public virtual ICollection<RetailerKoneksi> RetailerKoneksis { get; set; } = new List<RetailerKoneksi>();
