...
[Table("Pkp")]
[Index("KodeRetailer", "NoPkp", "SjId", Name = "IX_Pkp")]
[Index("KodeRetailer", "NoPkp", "IdKecamatan", "Order", Name = "UK_Pkp", IsUnique = true)]
public partial class Pkp
{
    ...
    [Unicode(false)]
    public string? BuktiTerima1 { get; set; }

    [Unicode(false)]
    public string? BuktiTerima2 { get; set; }
    ...
    public virtual ICollection<PkpDetail> PkpDetails { get; set; } = new List<PkpDetail>();
}
