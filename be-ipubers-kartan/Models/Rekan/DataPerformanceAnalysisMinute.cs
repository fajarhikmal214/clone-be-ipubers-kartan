...
[Table("data_performance_analysis_minutes")]
[Index("SaveTime", "ConnectionId", "SaveType", Name = "idx_data_performance_analysis_minutes_savetime_conn_id_save_type")]
public partial class DataPerformanceAnalysisMinute
{
    [Key]
    [Column("id")]
